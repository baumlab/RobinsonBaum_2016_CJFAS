...
## Script to calculate size spectrum slope using MLE of bounded power law exponent
...
#### ISD - size spectra estimation #####

# load in UVC data. Counts (= "number") of body sizes (="MASS") of reef fish > 10g
load("KI_abund_2011-2013.Rdata")

## full community size spectrum
isd<-plb_mlefunc(ki_lp, size="MASS", catch="number")

## trophic group size spectrum
isd.trophic<-ddply(ki_lp, .(TROPHIC), plb_mlefunc, size="MASS", catch="number")
